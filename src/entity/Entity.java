...
//Entity class to initialize and adjust the player, which is labeled as an entity.
public abstract class Entity {
	...
	//method to make entities collide with tile structures.
	...
	//update so that the environment is constantly updating based on entity movement.
	...
	//method to establish entity-entity collision. Not necessary if only using one entity.
