...
// when the state of the game is (pong) and the user selects the single player option/hard.
...
public class LevelHard {
	...
	public void update(Window window) {
		...
		if (!pause) {
			...
			if (ball.movement.y > 0 && ball.position.y > player2Short.position.y + 0.075f && ball.movement.x > 0 && ball.position.x > -0.6f) {
