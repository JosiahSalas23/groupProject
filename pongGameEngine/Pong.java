	...
	public void draw() {
		...
		switch (mode) {
			...
			case menu:
				...
				ShaderManager.paddleShader.setUniform3f("pos", easyButton.position);
				easyButton.draw();
				ShaderManager.paddleShader.stop();
				
				ShaderManager.paddleShader.start();
				ShaderManager.paddleShader.setUniform3f("pos", mediumButton.position);
				mediumButton.draw();
				ShaderManager.paddleShader.stop();
				
				ShaderManager.paddleShader.start();
				ShaderManager.paddleShader.setUniform3f("pos", hardButton.position);
				hardButton.draw();
				ShaderManager.paddleShader.stop();
				
				ShaderManager.paddleShader.start();
				ShaderManager.paddleShader.setUniform3f("pos", multiplayerButton.position);
