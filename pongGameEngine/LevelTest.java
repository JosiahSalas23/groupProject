// This class purpose is to test power ups and other functions in pong.
// when the state of the game is (pong) and the user presses t in the keyboard.
...
public class LevelTest {
	...
	public void giveAdvantageToPlayer1() {
		...
		selectPowerUp = player1.getScore() + 1;
	...
	public void update(Window window) {
		...
		if(!pause) {
			...
			if (nonPowerHitCount == 0 && !powerUpBallDroped && !powerUpActive) {
